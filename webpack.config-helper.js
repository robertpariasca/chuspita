...
module.exports = (options) => {
    ...
    let webpackConfig = {
        ...
        entry: {
            ...
            control: './src/scripts-init/control.js',
            menuitems: './src/scripts-init/menuitems.js',
            combos_llenar: './src/scripts-init/combos_llenar.js',
            segman_opciones: './src/scripts-init/SegMan.js',
            botones_acciones: './src/scripts-init/botones_acciones.js',
            listados: './src/scripts-init/listados.js',
            cargado_onload: './src/scripts-init/cargado_onload.js',
    ...
    if (options.isProduction) {
        webpackConfig.entry = [
            ...
            './src/scripts-init/login.js',
            './src/scripts-init/control.js',
            './src/scripts-init/menuitems.js',
            './src/scripts-init/combos_llenar.js',
            './src/scripts-init/SegMan.js',
            './src/scripts-init/botones_acciones.js',
            './src/scripts-init/listados.js',
            './src/scripts-init/cargado_onload.js',
